...
def main(
    ...
    input_ids = make_input_ids(
        ...
        # seed=seed,
        prepend_bos=model_name in ["gemma-7b", "llama2-7b", "mixtral-7b", "llama3-8b", "llama2-70b", "llama3-70b"],
        bos={"llama2-7b": 1, "gemma-7b": 2, "gemma-2-9b": 2, "mistral-7b": 1, "llama3-8b": 1, "llama2-70b": 1, "llama3-70b": 1}.get(model_name, None),
    )
